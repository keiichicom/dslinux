...
/* $Id: config.h.in,v 1.13 2007/11/11 16:06:52 cmatsuoka Exp $ */
...
/* #undef DRIVER_PULSEAUDIO */

/* Define to enable ALSA support */
/* #undef DRIVER_ALSA_SEQ */
/* #undef DRIVER_ALSA_MIX */
...
#define HAVE_AWE_MD_NEW_VOLUME_CALC 1
