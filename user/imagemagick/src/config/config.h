...
#define CODER_PATH "/nonexistent/lib/ImageMagick-6.4.2/modules-Q16/coders/"

/* Subdirectory of lib where coder modules are installed */
#define CODER_RELATIVE_PATH "ImageMagick-6.4.2/modules-Q16/coders"

/* Directory where architecture-dependent configuration files live. */
#define CONFIGURE_PATH "/nonexistent/lib/ImageMagick-6.4.2/config/"

/* Subdirectory of lib where architecture-dependent configuration files live.
   */
#define CONFIGURE_RELATIVE_PATH "ImageMagick-6.4.2/config"

/* Define if you have DJVU library */
/* #undef DJVU_DELEGATE */

/* Directory where ImageMagick documents live. */
#define DOCUMENTATION_PATH "/nonexistent/share/doc/ImageMagick-6.4.2/"
...
/* Build self-contained, embeddable, zero-configuration ImageMagick
   (experimental) */
#define EMBEDDABLE_SUPPORT 1

/* exclude deprecated methods in MagickCore API */
/* #undef EXCLUDE_DEPRECATED */

/* Directory where executables are installed. */
#define EXECUTABLE_PATH "/nonexistent/bin/"

/* Location of filter modules */
#define FILTER_PATH "/nonexistent/lib/ImageMagick-6.4.2/modules-Q16/filters/"

/* Subdirectory of lib where filter modules are installed */
#define FILTER_RELATIVE_PATH "ImageMagick-6.4.2/modules-Q16/filters"
...
#define LIBRARY_PATH "/nonexistent/lib/ImageMagick-6.4.2/"

/* Subdirectory of lib where ImageMagick architecture dependent files are
   installed */
#define LIBRARY_RELATIVE_PATH "ImageMagick-6.4.2"
...
#define PACKAGE_STRING "ImageMagick 6.4.2"
...
#define SHARE_CONFIGURE_PATH "/nonexistent/share/ImageMagick-6.4.2/config/"

/* Subdirectory of lib where architecture-independent configuration files
   live. */
#define SHARE_CONFIGURE_RELATIVE_PATH "ImageMagick-6.4.2/config"

/* Directory where architecture-independent files live. */
#define SHARE_PATH "/nonexistent/share/ImageMagick-6.4.2/"
