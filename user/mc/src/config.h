 ...
 */
#define NEED_EXTRA_DIRENT_BUFFER 1
...
/* Yet configure script is unchanged it works right that */

/* #undef HAVE_CHARSETS */
#define HAVE_CHARSETS 1

/* Define to enable dialog switching */
/* Yet configure script is unchanged it works right that */

/* #undef HAVE_DLGSWITCH */
#define HAVE_DLGSWITCH 1

/* Define if you have the PC-style console mapping.  See dlg.c:133*/
/* #define PC_DRW_CHARS 1 */
