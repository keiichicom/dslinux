This is a fork of the original dslinux source tree hosted here: https://svn.dslinux.org/svn/trunk/, which now runs on the Nintendo DSi and DSi XL. Note that if you are a Nintendo ds/ds lite owner, you should still use the original dslinux.
