cmd_drivers/mtd/devices/firmware.o := arm-linux-elf-gcc -Wp,-MD,drivers/mtd/devices/.firmware.o.d  -nostdinc -isystem /usr/local/dslinux-toolchain-2008-01-24-i686/bin/../lib/gcc/arm-linux-elf/4.0.4/include -D__KERNEL__ -Iinclude  -mlittle-endian -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer  -mno-thumb-interwork -D__LINUX_ARM_ARCH__=5 -march=armv5te   -msoft-float -Uarm -mswp-byte-writes -Wdeclaration-after-statement -Wno-pointer-sign    -DKBUILD_BASENAME=firmware -DKBUILD_MODNAME=firmware -c -o drivers/mtd/devices/firmware.o drivers/mtd/devices/firmware.c

deps_drivers/mtd/devices/firmware.o := \
  drivers/mtd/devices/firmware.c \
  include/asm/io.h \
...
drivers/mtd/devices/firmware.o: $(deps_drivers/mtd/devices/firmware.o)
