cmd_drivers/video/logo/logo.o := arm-linux-elf-gcc -Wp,-MD,drivers/video/logo/.logo.o.d  -nostdinc -isystem /usr/local/dslinux-toolchain-2008-01-24-i686/bin/../lib/gcc/arm-linux-elf/4.0.4/include -D__KERNEL__ -Iinclude  -mlittle-endian -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer  -mno-thumb-interwork -D__LINUX_ARM_ARCH__=5 -march=armv5te   -msoft-float -Uarm -mswp-byte-writes -Wdeclaration-after-statement -Wno-pointer-sign    -DKBUILD_BASENAME=logo -DKBUILD_MODNAME=logo -c -o drivers/video/logo/logo.o drivers/video/logo/logo.c
...
deps_drivers/video/logo/logo.o := \
  drivers/video/logo/logo.c \
    ...
    $(wildcard include/config/logo/nds/clut224.h) \
    $(wildcard include/config/logo/nds/big/clut224.h) \
