cmd_drivers/video/console/fonts.o := arm-linux-elf-gcc -Wp,-MD,drivers/video/console/.fonts.o.d  -nostdinc -isystem /usr/local/dslinux-toolchain-2008-01-24-i686/bin/../lib/gcc/arm-linux-elf/4.0.4/include -D__KERNEL__ -Iinclude  -mlittle-endian -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer  -mno-thumb-interwork -D__LINUX_ARM_ARCH__=5 -march=armv5te   -msoft-float -Uarm -mswp-byte-writes -Wdeclaration-after-statement -Wno-pointer-sign    -DKBUILD_BASENAME=fonts -DKBUILD_MODNAME=font -c -o drivers/video/console/fonts.o drivers/video/console/fonts.c
...
deps_drivers/video/console/fonts.o := \
  drivers/video/console/fonts.c \
    ...
    $(wildcard include/config/font/mini/4x9.h) \
    $(wildcard include/config/font/mini/6x6.h) \
