cmd_arch/arm/mach-nds/rtc.o := arm-linux-elf-gcc -Wp,-MD,arch/arm/mach-nds/.rtc.o.d  -nostdinc -isystem /usr/local/dslinux-toolchain-2008-01-24-i686/bin/../lib/gcc/arm-linux-elf/4.0.4/include -D__KERNEL__ -Iinclude  -mlittle-endian -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer  -mno-thumb-interwork -D__LINUX_ARM_ARCH__=5 -march=armv5te   -msoft-float -Uarm -mswp-byte-writes -Wdeclaration-after-statement -Wno-pointer-sign    -DKBUILD_BASENAME=rtc -DKBUILD_MODNAME=rtc -c -o arch/arm/mach-nds/rtc.o arch/arm/mach-nds/rtc.c

deps_arch/arm/mach-nds/rtc.o := \
  arch/arm/mach-nds/rtc.c \
...
arch/arm/mach-nds/rtc.o: $(deps_arch/arm/mach-nds/rtc.o)
