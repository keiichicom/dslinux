cmd_arch/arm/mach-nds/arch.o := arm-linux-elf-gcc -Wp,-MD,arch/arm/mach-nds/.arch.o.d  -nostdinc -isystem /usr/local/dslinux-toolchain-2008-01-24-i686/bin/../lib/gcc/arm-linux-elf/4.0.4/include -D__KERNEL__ -Iinclude  -mlittle-endian -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer  -mno-thumb-interwork -D__LINUX_ARM_ARCH__=5 -march=armv5te   -msoft-float -Uarm -mswp-byte-writes -Wdeclaration-after-statement -Wno-pointer-sign    -DKBUILD_BASENAME=arch -DKBUILD_MODNAME=arch -c -o arch/arm/mach-nds/arch.o arch/arm/mach-nds/arch.c

deps_arch/arm/mach-nds/arch.o := \
  arch/arm/mach-nds/arch.c \
    $(wildcard include/config/nds/fastgba.h) \
  ...
  include/asm/mach-types.h \
    ...
    $(wildcard include/config/mach/odyssey.h) \
    ...
    $(wildcard include/config/mach/cybertracker.h) \
...
arch/arm/mach-nds/arch.o: $(deps_arch/arm/mach-nds/arch.o)
