cmd_arch/arm/mach-nds/time.o := arm-linux-elf-gcc -Wp,-MD,arch/arm/mach-nds/.time.o.d  -nostdinc -isystem /usr/local/dslinux-toolchain-2008-01-24-i686/bin/../lib/gcc/arm-linux-elf/4.0.4/include -D__KERNEL__ -Iinclude  -mlittle-endian -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer  -mno-thumb-interwork -D__LINUX_ARM_ARCH__=5 -march=armv5te   -msoft-float -Uarm -mswp-byte-writes -Wdeclaration-after-statement -Wno-pointer-sign    -DKBUILD_BASENAME=time -DKBUILD_MODNAME=time -c -o arch/arm/mach-nds/time.o arch/arm/mach-nds/time.c

deps_arch/arm/mach-nds/time.o := \
  arch/arm/mach-nds/time.c \
...
arch/arm/mach-nds/time.o: $(deps_arch/arm/mach-nds/time.o)
